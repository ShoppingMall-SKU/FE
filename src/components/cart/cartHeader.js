export const CartHeader = ({ isAllChecked, handleCheckAll }) => {
    return (
        <>
            <header className="flex justify-center text-4xl lg:text-5xl font-semibold max-w-3xl mx-auto mt-16">
                <h1>장바구니</h1>
            </header>
            <div className="lg:max-w-5xl w-11/12 xl:max-w-7xl mx-auto items-center">
                <div className="flex bg-gray-100 rounded-2xl mt-12 h-16 justify-between items-center pl-7 pr-7 lg:pl-12 lg:pr-12">
                    <div className="">
                        <input
                            type="checkbox"
